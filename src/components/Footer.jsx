...
export default function Footer() {
  return (
    <footer className="border-t border-white/[0.05] py-8 bg-[#0c0c0c]">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
          ...
          <span className="text-[10px] tracking-[0.3em] uppercase text-white/20">Akbarali Sheronov</span>
        </motion.div>
        ...
        <motion.a href="#hero" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
