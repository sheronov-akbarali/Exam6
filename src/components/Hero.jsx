...
export default function Hero() {
	...
	return (
		<section
			...
			className='relative min-h-screen flex items-center justify-center overflow-hidden bg-page'
		>
			{/* ── Parallax orbs ── */}
			<div className='absolute inset-0 pointer-events-none'>
				...
				<div
					...
					style={{
						background:
							'radial-gradient(circle at 35% 35%, rgba(255,255,255,0.04) 0%, transparent 65%)',
				...
				<div
					...
					style={{
						background:
							'radial-gradient(circle at 65% 65%, rgba(255,255,255,0.025) 0%, transparent 65%)',
			...
			<div className='absolute inset-0 pointer-events-none overflow-hidden'>
				<motion.div
					...
					className='absolute top-[42%] left-0 right-0 h-px origin-left hero-rule-line-1'
					style={{
						background:
				...
				<motion.div
					...
					className='absolute top-[58%] left-0 right-0 h-px origin-right hero-rule-line-2'
					style={{
						background:
			...
			<div className='relative z-10 max-w-5xl mx-auto px-6 pt-28 pb-20 flex flex-col items-center text-center'>
				...
				>
					...
					>
						{[
							{ value: '1+', label: t('hero.stats.year') },
							{ value: '4', label: t('hero.stats.projects') },
							{ value: '1', label: t('hero.stats.client') },
						].map(stat => (
							<div
								key={stat.label}
			...
			>
				...
				<motion.div
					...
					className='w-px h-10 hero-scroll-line'
					style={{
						background:
